...
angular.module('admin.ludiCategories.index').config(['$routeProvider', function($routeProvider){
  $routeProvider
    .when('/admin/ludiCategories', {
      templateUrl: 'admin/ludiCategories/admin-ludiCategories.tpl.html',
      controller: 'LudiCategoriesIndexCtrl',
      title: 'Manage LudiCategories',
      resolve: {
        ludiCategories: ['$q', '$location', '$log', 'securityAuthorization', 'adminResource', function($q, $location, $log, securityAuthorization, adminResource){
          //get app stats only for admin-user, otherwise redirect to /account
          var redirectUrl;
          var promise = securityAuthorization.requireAdminUser()
            .then(function(){
              //handles url with query(search) parameter
              return adminResource.findLudiCategories($location.search());
            }, function(reason){
...
angular.module('admin.ludiCategories.index').controller('LudiCategoriesIndexCtrl', ['$scope', '$route', '$location', '$log', 'utility', 'adminResource', 'ludiCategories',
  function($scope, $route, $location, $log, utility, adminResource, data){
    ...
    var deserializeData = function(data){
      ...
      $scope.ludiCategories = data.data;
    };
